...
namespace Plugin.InAppBilling
{
	...
	public class InAppBillingImplementation : BaseInAppBilling
	{
        ...
        public override Task<InAppBillingPurchase> UpgradePurchasedSubscriptionAsync(string newProductId, string purchaseTokenOfOriginalSubscription, SubscriptionProrationMode prorationMode = SubscriptionProrationMode.ImmediateWithTimeProration, string obfuscatedProfileId = null, string subOfferToken = null) =>
